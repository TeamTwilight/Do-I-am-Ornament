...
public class LootTableGenerator extends LootTableProvider {
    ...
    public static class BlockTables extends OrnamentLootTableProvider {
        ...
        protected void addTables() {
            ...
            this.dropPole(ModBlocks.ironwood_pole);
            this.dropPole(ModBlocks.fiery_pole);
            this.dropPole(ModBlocks.steeleaf_pole);
            this.dropPole(ModBlocks.arctic_fur_pole);
            this.dropPole(ModBlocks.carminite_pole);
            this.dropPole(ModBlocks.twilight_oak_log_pole);
            this.dropPole(ModBlocks.canopy_log_pole);
            this.dropPole(ModBlocks.mangrove_log_pole);
            this.dropPole(ModBlocks.dark_oak_log_pole);
            this.dropPole(ModBlocks.time_log_pole);
            this.dropPole(ModBlocks.transformation_log_pole);
            this.dropPole(ModBlocks.mining_log_pole);
            this.dropPole(ModBlocks.sorting_log_pole);
            this.dropPole(ModBlocks.twilight_oak_plank_pole);
            this.dropPole(ModBlocks.canopy_plank_pole);
            this.dropPole(ModBlocks.mangrove_plank_pole);
            this.dropPole(ModBlocks.dark_oak_plank_pole);
            this.dropPole(ModBlocks.time_plank_pole);
            this.dropPole(ModBlocks.transformation_plank_pole);
            this.dropPole(ModBlocks.mining_plank_pole);
            this.dropPole(ModBlocks.sorting_plank_pole);

            this.dropBeam(ModBlocks.ironwood_beam);
            this.dropBeam(ModBlocks.fiery_beam);
            this.dropBeam(ModBlocks.steeleaf_beam);
            this.dropBeam(ModBlocks.arctic_fur_beam);
            this.dropBeam(ModBlocks.carminite_beam);
            this.dropBeam(ModBlocks.twilight_oak_log_beam);
            this.dropBeam(ModBlocks.canopy_log_beam);
            this.dropBeam(ModBlocks.mangrove_log_beam);
            this.dropBeam(ModBlocks.dark_oak_log_beam);
            this.dropBeam(ModBlocks.time_log_beam);
            this.dropBeam(ModBlocks.transformation_log_beam);
            this.dropBeam(ModBlocks.mining_log_beam);
            this.dropBeam(ModBlocks.sorting_log_beam);
            this.dropBeam(ModBlocks.twilight_oak_plank_beam);
            this.dropBeam(ModBlocks.canopy_plank_beam);
            this.dropBeam(ModBlocks.mangrove_plank_beam);
            this.dropBeam(ModBlocks.dark_oak_plank_beam);
            this.dropBeam(ModBlocks.time_plank_beam);
            this.dropBeam(ModBlocks.transformation_plank_beam);
            this.dropBeam(ModBlocks.mining_plank_beam);
            this.dropBeam(ModBlocks.sorting_plank_beam);
